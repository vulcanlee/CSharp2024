...
dotnet new MVVMItem --namespace mauiMessengerCommunication --view-name MyFirst

# Create a new View and ViewModel for Prism MAUI Project (don't append Page to view-name parameter)

dotnet new MVVMPrismItem --namespace mauiMessengerCommunication --view-name MyFirstXX
